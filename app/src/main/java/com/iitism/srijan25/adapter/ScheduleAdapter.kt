...
class ScheduleAdapter(private val dataList: List<ScheduleModel>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val timelineView = LayoutInflater.from(parent.context).inflate(R.layout.schedule_card, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val venue = currentItem.eventVenue
